...
# Errors callers can catch without importing botocore directly.
...
def storage_enabled() -> bool:
    """True only when S3 is fully configured and boto3 is importable."""
    return bool(
        boto3
...
def create_upload_url(organization_id, filename: str, content_type: str) -> dict:
    ...
    unsupported content type and StorageError on an S3 failure.
    """
